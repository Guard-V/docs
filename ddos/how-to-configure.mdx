...
Edge Rules allow you to control traffic flow based on various criteria like IP addresses, protocols, and packet characteristics.
...
<Steps>
  <Step title="Create Default Deny Rule">
    ...
    2. Set Source IP to "0.0.0.0/0" (all IPs)
  ...
  <Step title="Allow Specific Services">
    ...
    - Priority 2: Allow SSH (TCP port 22)
    - Priority 3: Allow HTTP/HTTPS (TCP ports 80/443)
    - Priority 4: Allow other required services
  </Step>
</Steps>
